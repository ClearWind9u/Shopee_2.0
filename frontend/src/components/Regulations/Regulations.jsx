...
const Regulations = () => {
  return (
    <div className="regulations-container">
      ...
      <ul>
        <li>Đảm bảo sản phẩm đăng bán có nguồn gốc rõ ràng, hợp pháp.</li>
        <li>Không đăng tải nội dung vi phạm pháp luật, đạo đức xã hội.</li>
        <li>Tuân thủ các chính sách về giá cả, vận chuyển và bảo hành.</li>
      </ul>

      <h4>3. Quy định về người mua</h4>
      <ul>
        <li>Không thực hiện hành vi gian lận, gây ảnh hưởng đến hệ thống.</li>
        <li>Thanh toán đầy đủ và đúng hạn theo phương thức đã chọn.</li>
        <li>Tuân thủ chính sách đổi trả và bảo hành của Shopee 2.0.</li>
      </ul>

      <h4>4. Chính sách bảo mật</h4>
      <p>
        Chúng tôi cam kết bảo vệ thông tin cá nhân của người dùng và không chia sẻ với bên thứ ba nếu không có sự đồng ý.
      </p>
